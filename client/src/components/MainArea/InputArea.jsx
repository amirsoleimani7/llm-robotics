    ...
    <>
      ...
      >
        <textarea
          ...
          className="bg-transparent placeholder:text-gray-400 focus:outline-none w-full h-[80%] resize-none dark:text-white text-black scrollbar-thin dark:scrollbar-thumb-[#3c3c3d]  dark:scrollbar-track-second-color scrollbar-thumb-[#e6e8ea] scrollbar-track-white "
          onKeyDown={(e) => {
            if (e.key === "Enter") {
              e.preventDefault();
              handle_input();
